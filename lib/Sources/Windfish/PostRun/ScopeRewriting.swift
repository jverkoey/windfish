...
extension Disassembler.BankWorker {
  ...
  private func propagateTypes(for run: Disassembler.Run) {
    ...
    Tracer.trace(range: visitedRange, cartridgeData: context.cartridgeData, disassembler: router!) { (instruction: LR35902.Instruction, currentLocation: Cartridge.Location, cpu: LR35902, memory: TraceableMemory) in
