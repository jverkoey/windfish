...
class AddressConversionTests: XCTestCase {
  ...
  func testZero() throws {
    ...
    let cartridgeLocation = LR35902.Cartridge.cartridgeLocation(for: address, in: bank)!
  ...
  func testUnselectedBankGivesNilCartAddressAbove0x3FFF() throws {
    XCTAssertNil(LR35902.Cartridge.cartridgeLocation(for: 0x4000, in: 0))
    XCTAssertNil(LR35902.Cartridge.cartridgeLocation(for: 0x6000, in: 0))
    XCTAssertNil(LR35902.Cartridge.cartridgeLocation(for: 0x9000, in: 0))
  }
