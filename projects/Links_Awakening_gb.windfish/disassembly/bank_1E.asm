...
toc_1E_403F.else_1E_4050:
    assign [$D379], $01
    ld   hl, $4068
    jp   toc_1E_4072

toc_1E_403F.else_1E_405B:
    ld   a, [de]
    dec  a
    ld   [de], a
    ret  nz
...
toc_1E_457C.toc_1E_459E:
    inc  l
    inc  l
toc_1E_457C.toc_1E_45A0:
    call toc_1E_4497
    cp   $00
    jp   z, toc_1E_44D7
...
toc_1E_457C.else_1E_4609:
    ...
    add  a, d
toc_1E_457C.else_1E_461A:
    ld   c, a
    and  a
    jr   nz, .else_1E_4620

    ld   c, $02
toc_1E_457C.else_1E_4620:
    ld   de, $D350
    ld   a, [de]
    dec  a
    ld   e, a
    ...
    ld   [hl], c
    pop  af
toc_1E_457C.toc_1E_462E:
    pop  hl
    dec  l
    ldi  [hl], a
    call toc_1E_4482
    call toc_1E_4497
toc_1E_457C.else_1E_4637:
...
toc_1E_457C.else_1E_4667:
    ...
    ld   [de], a
    clear [$D3DA]
toc_1E_457C.else_1E_4675:
    pop  de
toc_1E_457C.else_1E_4676:
    ld   c, b
    ld   b, $00
    call toc_1E_4482
    ld   a, [$D350]
    ...
    ld   h, $FF
toc_1E_457C.else_1E_46A3:
    add  hl, bc
    ld   b, h
    ld   c, l
toc_1E_457C.else_1E_46A6:
    ld   hl, $49BA
    add  hl, bc
    ldi  a, [hl]
    ld   [de], a
...
toc_1E_457C.else_1E_46B3:
    ld   [hl], $01
    pop  hl
    jr   .toc_1E_46E9

toc_1E_457C.toc_1E_46B8:
    push hl
    ld   a, c
    cp   $FF
    jr   z, .else_1E_46D6
...
toc_1E_457C.else_1E_4710:
    ld   c, $16
    jr   .toc_1E_4717

toc_1E_457C.else_1E_4714:
    ld   c, $10
    inc  c
toc_1E_457C.toc_1E_4717:
    inc  l
    inc  l
    ldi  a, [hl]
    ld   e, a
...
toc_1E_457C.toc_1E_473A:
    ...
    or   $80
    ld   [$ff00+c], a
toc_1E_457C.else_1E_4748:
    pop  hl
    dec  l
    ldd  a, [hl]
    ldd  [hl], a
    dec  l
toc_1E_457C.toc_1E_474D:
    ld   de, $D350
    ld   a, [de]
    cp   $04
    jr   z, .else_1E_475E
