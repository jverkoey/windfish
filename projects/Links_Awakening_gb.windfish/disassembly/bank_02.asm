...
toc_02_46B4:
    ...
    dec  [hl]
toc_02_46F0:
    if   [$C121], toc_02_4738.else_02_485E
...
toc_02_5B15:
    if   [$C18E], JumpTable_5BAF_02.return_02_5BC8
...
JumpTable_6C48_02.else_02_6C63:
    if   [$DB0C], toc_02_77FA.else_02_79D9
