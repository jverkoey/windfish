...
toc_02_4497.else_02_4557:
    copyFromTo [$FF99], [$FFD8]
    copyFromTo [$FF98], [$FFD7]
    assign [$FFF2], $0E
    ld   a, $0C
    call toc_01_0953
    ret
...
toc_02_4CAC:
    copyFromTo [$FFD7], [$FFCE]
    swap a
    and  %00001111
    ld   e, a
    copyFromTo [$FFD8], [$FFCD]
    and  %11110000
    or   e
    ld   e, a
    ld   d, $00
...
toc_02_59E1.toc_02_5A10:
    ...
    copyFromTo [$FF98], [$DBB1]
    copyFromTo [$FF99], [$DBB2]
...
toc_02_6E9F.else_02_6F24:
    ...
    copyFromTo [$FFA0], [$FF99]
toc_02_6E9F.else_02_6F2F:
    ld   a, [$C133]
    and  %00000011
    jr   z, .return_02_6F6A

    copyFromTo [$FF9F], [$FF98]
