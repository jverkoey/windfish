...
class ProjectDocument: NSDocument {
  ...
  var cpuState: LR35902.CPUState = {
    ...
    state.ram[0xFF10] = .init(value: 0x80, sourceLocation: nil)
    state.ram[0xFF11] = .init(value: 0xBF, sourceLocation: nil)
    state.ram[0xFF12] = .init(value: 0xF3, sourceLocation: nil)
    state.ram[0xFF14] = .init(value: 0xBF, sourceLocation: nil)
    state.ram[0xFF16] = .init(value: 0x3F, sourceLocation: nil)
    state.ram[0xFF17] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF19] = .init(value: 0xBF, sourceLocation: nil)
    state.ram[0xFF1A] = .init(value: 0x7F, sourceLocation: nil)
    state.ram[0xFF1B] = .init(value: 0xFF, sourceLocation: nil)
    state.ram[0xFF1C] = .init(value: 0x9F, sourceLocation: nil)
    state.ram[0xFF1E] = .init(value: 0xBF, sourceLocation: nil)
    state.ram[0xFF20] = .init(value: 0xFF, sourceLocation: nil)
    state.ram[0xFF21] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF22] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF23] = .init(value: 0xBF, sourceLocation: nil)
    state.ram[0xFF24] = .init(value: 0x77, sourceLocation: nil)
    state.ram[0xFF25] = .init(value: 0xF3, sourceLocation: nil)
    state.ram[0xFF26] = .init(value: 0xF1, sourceLocation: nil)
    state.ram[0xFF40] = .init(value: 0x91, sourceLocation: nil)
    state.ram[0xFF42] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF43] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF45] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF47] = .init(value: 0xFC, sourceLocation: nil)
    state.ram[0xFF48] = .init(value: 0xFF, sourceLocation: nil)
    state.ram[0xFF49] = .init(value: 0xFF, sourceLocation: nil)
    state.ram[0xFF4A] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFF4B] = .init(value: 0x00, sourceLocation: nil)
    state.ram[0xFFFF] = .init(value: 0x00, sourceLocation: nil)
    return state
  }() {
    didSet {
