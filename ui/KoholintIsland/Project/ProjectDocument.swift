...
class ProjectDocument: NSDocument {
  ...
  var cpuState: LR35902.CPUState = {
    ...
    state.ram[0xFF05] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF06] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF07] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF10] = .init(value: 0x80, sourceLocation: 0)
    state.ram[0xFF11] = .init(value: 0xBF, sourceLocation: 0)
    state.ram[0xFF12] = .init(value: 0xF3, sourceLocation: 0)
    state.ram[0xFF14] = .init(value: 0xBF, sourceLocation: 0)
    state.ram[0xFF16] = .init(value: 0x3F, sourceLocation: 0)
    state.ram[0xFF17] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF19] = .init(value: 0xBF, sourceLocation: 0)
    state.ram[0xFF1A] = .init(value: 0x7F, sourceLocation: 0)
    state.ram[0xFF1B] = .init(value: 0xFF, sourceLocation: 0)
    state.ram[0xFF1C] = .init(value: 0x9F, sourceLocation: 0)
    state.ram[0xFF1E] = .init(value: 0xBF, sourceLocation: 0)
    state.ram[0xFF20] = .init(value: 0xFF, sourceLocation: 0)
    state.ram[0xFF21] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF22] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF23] = .init(value: 0xBF, sourceLocation: 0)
    state.ram[0xFF24] = .init(value: 0x77, sourceLocation: 0)
    state.ram[0xFF25] = .init(value: 0xF3, sourceLocation: 0)
    state.ram[0xFF26] = .init(value: 0xF1, sourceLocation: 0)
    state.ram[0xFF40] = .init(value: 0x91, sourceLocation: 0)
    state.ram[0xFF42] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF43] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF45] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF47] = .init(value: 0xFC, sourceLocation: 0)
    state.ram[0xFF48] = .init(value: 0xFF, sourceLocation: 0)
    state.ram[0xFF49] = .init(value: 0xFF, sourceLocation: 0)
    state.ram[0xFF4A] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFF4B] = .init(value: 0x00, sourceLocation: 0)
    state.ram[0xFFFF] = .init(value: 0x00, sourceLocation: 0)
    return state
  }() {
    didSet {
