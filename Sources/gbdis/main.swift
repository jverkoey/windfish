...
request.createDatatype(named: "bool", enumeration: [0: "false", 1: "true"], representation: .decimal)
...
request.createDatatype(named: "MUSIC_TIMING", enumeration: [
  0: "MUSIC_TIMING_NORMAL",
  1: "MUSIC_TIMING_DOUBLE",
  2: "MUSIC_TIMING_HALF",
], representation: .decimal)
request.createDatatype(named: "ENTITY_STATE", enumeration: [
...
request.createDatatype(named: "LINK_GROUND_STATUS", enumeration: [
  0: "LINK_GROUND_DRY",
  1: "LINK_GROUND_STEPS",
  3: "LINK_GROUND_WET_OR_GRASSY",
  7: "LINK_GROUND_PIT",
], representation: .decimal)
request.createDatatype(named: "ROOM_TRANSITION", enumeration: [
...
request.createDatatype(named: "ROOM_TRANSITION_DIRECTION", enumeration: [
  0: "ROOM_TRANSITION_DIR_RIGHT",
  1: "ROOM_TRANSITION_DIR_LEFT",
  2: "ROOM_TRANSITION_DIR_TOP",
  3: "ROOM_TRANSITION_DIR_BOTTOM",
], representation: .decimal)
request.createDatatype(named: "SWORD_DIRECTION", enumeration: [
...
request.createDatatype(named: "SWORD_ANIMATION_STATE", enumeration: [
