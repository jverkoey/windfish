...
disassembleJumpTable(within: 0x747B..<0x747D, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x76B4..<0x76B6, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x79E5..<0x79E7, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x7CCE..<0x7CD0, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x7DA6..<0x7DA8, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x7E82..<0x7E84, in: 0x04, selectedBank: 0x04)
disassembleJumpTable(within: 0x40AE..<0x40B0, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x461E..<0x4620, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x47F9..<0x47FB, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x4988..<0x498A, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x4BFF..<0x4C01, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x4EB7..<0x4EB9, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x51A4..<0x51A6, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x52C4..<0x52C6, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x5395..<0x5397, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x54B0..<0x54B2, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x59C1..<0x59C3, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x628B..<0x628D, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x62CD..<0x62CF, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x6701..<0x6703, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x67E9..<0x67EB, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x6C50..<0x6C52, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x7B4E..<0x7B50, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x7D93..<0x7D95, in: 0x05, selectedBank: 0x05)
disassembleJumpTable(within: 0x404C..<0x404E, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x4172..<0x4174, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x426E..<0x4270, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x4585..<0x4587, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x47F8..<0x47FA, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x4964..<0x4966, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x4AE0..<0x4AE2, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x4BFC..<0x4BFE, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x5143..<0x5145, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x53D1..<0x53D3, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x54DB..<0x54DD, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x56EE..<0x56F0, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x5824..<0x5826, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x5B71..<0x5B73, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x5DA6..<0x5DA8, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x5F6A..<0x5F6C, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x6117..<0x6119, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x61DA..<0x61DC, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x62F0..<0x62F2, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x6757..<0x6759, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x68D7..<0x68D9, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x6C81..<0x6C83, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x6D17..<0x6D19, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x6F7A..<0x6F7C, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7069..<0x706B, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x726A..<0x726C, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7383..<0x7385, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x74C5..<0x74C7, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7574..<0x7576, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7621..<0x7623, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x773F..<0x7741, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7AC8..<0x7ACA, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7C7F..<0x7C81, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7DBF..<0x7DC1, in: 0x06, selectedBank: 0x06)
disassembleJumpTable(within: 0x7EC7..<0x7EC9, in: 0x06, selectedBank: 0x06)
