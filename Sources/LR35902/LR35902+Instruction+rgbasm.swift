...
public let operandWidth = 4
public func assembly(for instruction: LR35902.Instruction, with cpu: LR35902? = nil) -> String {
...
private func operandAssembly(for instruction: LR35902.Instruction, with cpu: LR35902? = nil) -> String? {
...
private func describe(for instruction: LR35902.Instruction, operand: LR35902.Operand) -> String {
  switch operand {
